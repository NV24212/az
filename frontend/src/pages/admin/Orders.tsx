                ...
                {orders.map((o, i) => (
                  <tr key={o.orderId} className={i % 2 ? 'bg-slate-50' : ''}>
                    ...
                    <td className="py-2 pr-4">
                      <select value={o.status} onChange={(e) => updateStatus({ id: o.orderId, status: e.target.value as Order['status'] })} className="rounded-lg border border-slate-300 px-2 py-1 focus:outline-none focus:ring-2 focus:ring-[var(--brand)]">
